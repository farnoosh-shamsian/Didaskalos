...
# The Perfect Indicative Active (μι-Verbs)
...
The perfect reports a completed action **whose result still holds**: δέδωκα "I have given (and it is now theirs)", ἕστηκα "I stand" — literally "I have taken up a standing position."

For μι-verbs this tense is unusually rewarding, because two of the commonest perfects have **present meaning**:

| Verb | Perfect | Literal | Ordinary translation |
| --- | --- | --- | --- |
...
**reduplication + stem + ‑κα + perfect active endings.** The reduplication repeats the initial consonant with ε; a verb beginning with a vowel lengthens it instead.

### 2.2 Full Paradigm: **δίδωμι** → **δέδωκα** "I have given"

| Person | Form | Gloss |
| --- | --- | --- |
| 1 sg | **δέδωκα** | I have given |
| 2 sg | **δέδωκας** | you have given |
| 3 sg | **δέδωκε(ν)** | he/she has given |
| 1 pl | **δεδώκαμεν** | we have given |
...
ἕστηκα has both long forms and a shorter set in the plural, and the short ones are the commoner in Attic:

| Person | Long | Short | Meaning |
| --- | --- | --- | --- |
| 1 sg | **ἕστηκα** | — | I stand |
| 2 sg | **ἕστηκας** | — | you stand |
| 3 sg | **ἕστηκε(ν)** | — | he stands |
| 1 pl | ἑστήκαμεν | **ἕσταμεν** | we stand |
| 2 pl | ἑστήκατε | **ἕστατε** | you stand |
| 3 pl | ἑστήκασι(ν) | **ἑστᾶσι(ν)** | they stand |

Infinitive **ἑστάναι**, participle **ἑστώς, ἑστῶσα, ἑστός** "standing". The pluperfect **εἱστήκη** correspondingly means "I was standing".
...
| Rule | Explanation |
| --- | --- |
| **1. Reduplication with the rough breathing** | ἵστημι reduplicates as ἑ‑ with a rough breathing: ἕστηκα, not *σέστηκα. The original σ‑ of the stem survives only as that breathing. |
