...
## 3. Date Is Not Dialect

One warning, because it will otherwise confuse you. Several authors in the late group write deliberately archaic Attic, centuries after anyone spoke it. Lucian, Plutarch, Dionysius of Halicarnassus and Athenaeus all belong to a movement — **Atticism** — that treated the Attic of Plato and Demosthenes as the only proper literary Greek and imitated it closely.

So a second-century CE author may write more conservatively than a first-century BCE one. You cannot read a form's age off its author's dates. What you can do is learn the handful of signals below and let the forms speak for themselves.

## 4. The Five Signals You Will Actually Notice

These five account for the large majority of "why does this look wrong" moments.
...
Aeschylus and Sophocles wrote in Athens, but tragedy is not plain Attic. The spoken dialogue is Attic with an archaic, elevated vocabulary, while the **choral odes are written in a Doric-flavored literary language** — most visibly, they keep long **ᾱ** *ā* where Attic prose has **η** *ē*: μάτηρ *mátēr* for Attic μήτηρ *mḗtēr* "mother", γᾶ *gâ* for γῆ *gê* "earth", φάμα *pháma* for φήμη *phḗmē* "report". If a chorus looks like it is using the wrong vowel throughout, that is the convention, not an error.

This is worth setting beside §4, because the two look contradictory until you see the pattern. Attic itself has **both** vowels: it keeps ᾱ *ā* after ε, ι and ρ (χώρᾱ *chṓrā* "land", ἡμέρᾱ *hēmérā* "day") and turns it into η *ē* everywhere else (μήτηρ *mḗtēr*). Ionic went further and used η *ē* in every position, which is why Herodotus writes χώρη *chṓrē*; Doric went the other way and kept ᾱ *ā* throughout, which is why the choruses write μάτηρ *mátēr*. So Attic sits between the two, and whether a given word looks Ionic or Doric depends on the letter in front of the vowel.
...
- *Soph. Ant.*, *Aesch. Ag.* and the other tragedies — Attic verse, with Doric-colored choral odes (§6).
...
1. θάλασσα *thálassa* — *Hdt. 1.1*
2. πολέμοιο *polémoio* — *Hom. Il. 2.1*
3. μάτηρ *mátēr* — *Soph. Ant.*, in a choral ode
...
2. **Regular for epic.** -οιο *-oio* is the older genitive singular of the second declension; Attic has πολέμου *polémou*. Longer than the paradigm, therefore older.
