...
Every Greek sentence in this book is real. Nothing has been invented or simplified — each exercise sentence was taken from a text that someone actually wrote. That is the strength of this method, and it has one consequence you should know about before you start: **the texts were not all written at the same time, or in the same kind of Greek.**

The authors in this collection are separated by as much as nine hundred years. Homer is further from the New Testament than Chaucer is from us. In that time the language changed — endings were lost, contractions happened, whole grammatical categories died out — and the writers also came from different regions, each with its own dialect. So you will meet forms that do not match the paradigms you have just been learning.
...
**This book teaches Attic as its reference point.** Attic is the dialect of most surviving classical prose, it is what nearly every grammar and dictionary is organized around, and Koine grew directly out of it. Every paradigm in every lesson that follows is the Attic one unless that lesson says otherwise. This is the last time the book will say so: from here on, take it as given rather than expect a reminder.

What does need saying is that the **Dialect and Period** section at the end of each grammar lesson — called **Historical Development & Etymology** in the verb lessons — is worth a different amount to different readers. Read it according to the corpus you chose:
