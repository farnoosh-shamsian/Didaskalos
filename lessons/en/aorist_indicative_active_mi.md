...
| Term | Meaning in Greek grammar | Rough analogue |
|------|--------------------------|---------------------------|
| **Aorist** | A past aspect that presents the action as a simple whole, without reference to duration or repetition. | "he went," "she said," "I gave." |
| **Indicative** | The mood of facts and real events. | The "statement" mood. |
...
The most important pattern is the "**kappa aorist**": the suffix **‑κα** in the **singular** and the short stem without κ in the **plural**. Only three verbs have it: δίδωμι, τίθημι, ἵημι.

### 2.1 The Verb **δίδωμι** "to give" → **ἔδωκα**
...
*Stem:* singular **θηκ‑**, plural **θε‑**. Again the present reduplication (τι‑) is dropped.

### 2.3 The Verb **ἵστημι** "to set up / to stand" — Two Aorists

**a) The root aorist ἔστην "I stood" (intransitive):**
...
**b) The sigmatic aorist ἔστησα "I set up" (transitive):**

| Person | Singular | Plural |
|--------|----------|--------|
| **1st** | ἔστησα | ἐστήσαμεν |
| **2nd** | ἔστησας | ἐστήσατε |
| **3rd** | ἔστησε(ν) | ἔστησαν |

### 2.4 The Verb **φημί** "to say"

The narrative past of φημί is **ἔφην** (strictly classed as an imperfect, but used in narrative exactly like an aorist):
...
| Pattern | Marker | Example verbs | Aorist |
|---------|-----------------------|--------------|----------------|
| **Kappa aorist** | ‑κα in the singular, short stem in the plural | δίδωμι, τίθημι, ἵημι | ἔδωκα/ἔδομεν, ἔθηκα/ἔθεμεν, ἧκα/εἷμεν |
| **Root aorist** | endings directly on the long root | ἵστημι (intrans.), βαίνω, γιγνώσκω | ἔστην, ἔβην, ἔγνων |
| **Sigmatic** | ‑σα (like ω-verbs) | ἵστημι (trans.) | ἔστησα |

All the patterns take the **augment** ἐ‑ (or vowel lengthening) in the indicative.
...
| Verb | Present stem | Aorist stem | Aorist indicative active (complete) |
|------|--------------------|-------------|---------------------------------|
