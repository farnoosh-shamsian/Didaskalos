...
The **nominative** is the case of the subject — the form a noun has when it *does* something or *is* something. The **vocative** is the case of direct address — the form it takes when someone is being called or spoken to.

The two are taught together because they are two sides of one form. Across all three declensions they are built on the same stem, and in the great majority of nouns the vocative is simply **identical to the nominative**; only a limited set of patterns has a distinct vocative of its own. Learn the nominative and you have already learned most of the vocative.

---

## 1. The Nominative: the Naming Case

The nominative does three jobs.

**Subject of a finite verb.** The noun that performs the action stands in the nominative, and the verb agrees with it in number.

- **ὁ ἄνθρωπος λέγει.** — "The man speaks."
- **οἱ στρατιῶται μάχονται.** — "The soldiers are fighting."

**Predicate nominative.** After a linking verb — εἰμί "be", γίγνομαι "become", καλέομαι "be called" — the complement is *also* nominative, not accusative. Both nouns name the same person or thing, so both stand in the same case.
...
## 2. The Vocative: the Case of Address

The vocative stands outside the grammar of its sentence: it is governed by no verb and no preposition, and it can be removed without leaving a gap.

> **ὦ Σώκρατες, τί λέγεις;** — "Socrates, what are you saying?"

Unlike the nominative it takes **no article**. Compare **ὁ ἄνθρωπος λέγει** "the man speaks" (nominative, subject) with **ὦ ἄνθρωπε, λέγε** "man, speak!" (vocative, address).
...
## 3. The Endings, Declension by Declension
...
The third declension has no single nominative ending: some nouns add ‑ς to the stem (φύλαξ < φυλακ‑ς), others lengthen the stem vowel instead (πατήρ, δαίμων). For most of them the vocative is the same as that nominative. The exceptions form the bare stem, almost always with a **recessive accent**.
...
1. **Stem + case-ending** — both cases begin with the lexical stem; the appropriate ending is then attached.
2. **Default identity** — unless a specific rule applies, the vocative is the same as the nominative. This is true of all neuters, all plurals, all duals, and most third-declension nouns.
3. **Distinct singulars** — a separate vocative exists chiefly in the 1st-declension masculine (‑ς dropped), the 2nd-declension masculine (‑ος → ‑ε), and third-declension nouns forming the bare stem.
4. **Accent** — the vocative frequently draws its accent back toward the beginning of the word: πατήρ → πάτερ, Σωκράτης → Σώκρατες, δεσπότης → δέσποτα. The accent shift does not change the ending.
5. **Article** — the nominative regularly takes the article (ὁ ἄνθρωπος); the vocative never does.
6. **Nominative for address** — Greek sometimes uses a nominative with the article instead of a vocative, especially in brusque or colloquial commands: ὁ παῖς, ἀκολούθει "boy, follow!"
...
Between them these two cases are the least burdensome part of the noun system: the nominative is the form you already know from the dictionary, and the vocative repeats it except in a handful of singular patterns — watch for the ‑ς that drops, the ‑ος that becomes ‑ε, and the accent pulling back toward the front of the word.
