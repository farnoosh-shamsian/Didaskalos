...
| Tense | How the action is viewed | When | Rough English |
|---|---|---|---|
...
The last column is an approximation, and it is the least reliable part of the table. Languages divide up time and completion differently, and no set of translations lines up with the Greek exactly; the middle two columns are what you should actually learn. The Greek distinction is between **viewing an action as an unbroken whole** (aorist), **viewing it as in progress** (present, imperfect), and **viewing it as done but still mattering** (perfect, pluperfect).

That matters because outside the indicative mood — in infinitives, commands, subjunctives — aorist and present mark *only* this difference of view and say nothing at all about past time. This idea takes getting used to, and the lessons will return to it often.
...
|---|---|---|---|
| Indicative | statement of fact | λύει "he loosens" | lýei |
| Subjunctive | possibility, purpose, exhortation | ἵνα λύῃ "so that he may loosen" | hína lýēi |
...
2. 2nd person singular, aorist, passive, indicative — "you were educated". The ἐ- is the augment, which tells you both that it is past and that it is an indicative.
